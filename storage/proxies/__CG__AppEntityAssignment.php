...
class Assignment extends \App\Entity\Assignment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Assignment' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Assignment' . "\0" . 'startDate', '' . "\0" . 'App\\Entity\\Assignment' . "\0" . 'endDate', '' . "\0" . 'App\\Entity\\Assignment' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Assignment' . "\0" . 'user'];
        }
